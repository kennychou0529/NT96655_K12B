...
INT32 System_OnVideoAttach(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    {
        //TM_Begin(UI_INIT);
        //while (UI_ShowLogoFile(UI_LOGO_POWERON1,JpgAddr,JpgSize))
        {
       //GxVideo_SetDeviceCtrl(DOUT1, DISPLAY_DEVCTRL_BACKLIGHT, TRUE);
        UI_ShowLogoFile(UI_LOGO_POWERON1,JpgAddr,JpgSize);
	 GxVideo_SetDeviceCtrl(DOUT1, DISPLAY_DEVCTRL_BACKLIGHT, TRUE);
		//GPIOMap_TurnOnLCDBacklight();
		debug_msg("System_OnVideoAttach########\n\r");
        Delay_DelayMs(100); // delay some time to avoid LCD flicker as power on
         UI_ShowLogoFile(UI_LOGO_POWERON2,JpgAddr,JpgSize);
	 debug_msg("System_OnVideoAttach########\n\r");
       Delay_DelayMs(100);
	UI_ShowLogoFile(UI_LOGO_POWERON3,JpgAddr,JpgSize);
       Delay_DelayMs(100);
	UI_ShowLogoFile(UI_LOGO_POWERON4,JpgAddr,JpgSize);
       Delay_DelayMs(100);
	UI_ShowLogoFile(UI_LOGO_POWERON5,JpgAddr,JpgSize);
        Delay_DelayMs(100);
      UI_ShowLogoFile(UI_LOGO_POWERON6,JpgAddr,JpgSize);
        Delay_DelayMs(100);
	UI_ShowLogoFile(UI_LOGO_POWERON7,JpgAddr,JpgSize);
        Delay_DelayMs(100);
       UI_ShowLogoFile(UI_LOGO_POWERON8,JpgAddr,JpgSize);
        Delay_DelayMs(100);
	UI_ShowLogoFile(UI_LOGO_POWERON9,JpgAddr,JpgSize);
        Delay_DelayMs(100);
      UI_ShowLogoFile(UI_LOGO_POWERON10,JpgAddr,JpgSize);
        Delay_DelayMs(100);
	UI_ShowLogoFile(UI_LOGO_POWERON11,JpgAddr,JpgSize);
        Delay_DelayMs(170);
      }
        UI_GfxInit();
        UI_DispInit();
...
INT32 System_OnVideoAttach(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	...
	// if (SysGetFlag(FL_OPENING_LOGO)==OPENING_LOGO_ON)
      {
        debug_msg("vincent@20150818 show power on pics\r\n");
	...
	UI_ShowLogoFile(UI_LOGO_POWERON11,JpgAddr,JpgSize);
        ...
        {
            debug_msg("vincent@20150818 show power on movies\r\n");
            sprintf(szSectionID, "%s%d", g_szSecID, index);
            UI_ShowLogoFile(szSectionID,JpgAddr,JpgSize);
            Delay_DelayMs(170);
        }*/
        #endif
      }
