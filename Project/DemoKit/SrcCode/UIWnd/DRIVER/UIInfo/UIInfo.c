...
void SysCheckFlag(void)
{
    ...
    SysLimitFlag(FL_LCDOFF,             0,  LCDOFF_SETTING_MAX,          DEFAULT_LCDOFF);
     SysLimitFlag(FL_DELAYOFF,             0, DELAYOFF_ID_MAX,          DEFAULT_DELAYOFF);
    //Wi-Fi
    SysLimitFlag(FL_WIFI,                 0,                    WIFI_ID_MAX,             DEFAULT_WIFIOFF);
...
//    SysSetFlag(FL_MOVIE_EV,             DEFAULT_MOVIE_EV);
    ...
    SysSetFlag(FL_MOVIE_PARKING,        DEFAULT_MOVIE_PARKING);//eric edit
    ...
    SysSetFlag(FL_WIFI,               DEFAULT_WIFIOFF);
...
//    Ux_SendEvent(&UISystemObjCtrl,NVTEVT_EXE_OPENING,       1,  SysGetFlag(FL_OPENING_LOGO));
 ...
 Ux_SendEvent(&CustomMovieObjCtrl,NVTEVT_EXE_MOVIEGPS,            1,      SysGetFlag(FL_MOVIE_GPS));
    ...
    /*--- Wi-Fi ---*/
     Ux_SendEvent(&UISetupObjCtrl,NVTEVT_EXE_WIFI,    1,  SysGetFlag(FL_WIFI));//eric edit
