...
SHOW_ITEM_GROUP(CMD_Group,Normal2,65,58,266,79)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiMobileLinkOK_StaticTXT_LinkSts,0,65,58,266,79)
...
SHOW_ITEM_GROUP(CMD_Group,Normal28,60,112,309,133)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiMobileLinkOK_StaticTXT_MAC,0,60,112,309,133)
