...
BOOL g_bWifistaus = FALSE;//ERIC EDIT 0909-1
BOOL g_bWifiEscStaus = FALSE;////eric edit 0909-3
...
EVENT_ITEM(NVTRET_PROTECT,UIMenuWndWiFiMobileLink_OnGsensor)//eric ±ê¼Ç
...
INT32 UIMenuWndWiFiMobileLink_OnMovieOneSec(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	...
	UINT32 uiKeyAct;
	 uiKeyAct = paramNum ? paramArray[0] : 0;
	debug_msg("^G   Wifi  link  rec Sec : %d\r\n",paramArray[0]);
     return NVTEVT_CONSUME;
    #endif
}
...
//EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIMenuWndWiFiModeLink_Tab_RefreshAndWiFiOff_OnKeyLeft)
...
INT32 UIMenuWndWiFiModeLink_Tab_RefreshAndWiFiOff_OnKeyEnter(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    case NVTEVT_KEY_PRESS:
        ...
        case UIMenuWndWiFiModeLink_Tab_RefreshAndWiFiOff_Button_WiFiOff:
		   g_bWifiEscStaus = TRUE;//eric edit 0909-3
...
{
    g_bWifistaus = TRUE;//ERIC EDIT 0909-1
    Ux_CloseWindowClear(&UIMenuWndWiFiModuleLinkCtrl,1,Wifi_wait_Link);    
