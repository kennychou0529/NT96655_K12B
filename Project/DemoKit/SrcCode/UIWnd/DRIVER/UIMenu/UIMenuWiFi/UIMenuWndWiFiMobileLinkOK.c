...
//EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIMenuWndWiFiMobileLinkOK_OnKeyShutter2)//eric edit
EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIMenuWndWiFiMobileLinkOK_OnKeyenter)//eric edit
//EVENT_ITEM(NVTEVT_KEY_UP,UIMenuWndWiFiMobileLinkOK_OnKeyUP)//eric edit
EVENT_ITEM(NVTEVT_CB_MOVIE_REC_FINISH,UIMenuWndWiFiMobileLinkOK_OnMovieFinish)
EVENT_ITEM(NVTRET_PROTECT,UIMenuWndWiFiMobileLinkOK_Gsensor)//eric ±ê¼Ç
...
INT32 UIMenuWndWiFiMobileLinkOK_OnKeyShutter2(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    case NVTEVT_KEY_PRESS:
		...
		//debug_msg("UIMenuWndWiFiMobileLinkOK_OnKeyShutter2**********************111111111111*************************ERIC_DEBUG\n\r");//ERIC_DEBUG
