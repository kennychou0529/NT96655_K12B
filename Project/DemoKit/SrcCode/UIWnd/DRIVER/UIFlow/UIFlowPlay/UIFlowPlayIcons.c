        ...
        if (uiPBFileFmt & PBFMT_READONLY)
         {
            ...
            strncpy(item1_Buf, (gchaFullName+rootFolderLength+10),20);//Eric 20150905¡ª3
            item1_Buf[20] = '\0';
         } else {
...
void FlowPB_IconDrawMovBwd(BOOL bShow)  //ERIC 150907 -2 BEGIN
{
    if (bShow==TRUE)
    	{
...
void FlowPB_IconDrawMovPlay(BOOL bShow)   //ERIC 2015 0907 -1 BEGIN
{
    if (bShow==FALSE)
    {
