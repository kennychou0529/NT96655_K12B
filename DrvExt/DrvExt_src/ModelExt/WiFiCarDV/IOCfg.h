...
// Wi-Fi power
#define GPIO_WIFI_POWER_PWM5        D_GPIO_0//C_GPIO_15//P_GPIO_41
...
#define GPIO_RED_LED                P_GPIO_55
#define PAD_RED_LED                 PAD_PIN_PGPIO55

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_GREEN_BY_GPIO
#define GPIO_GREEN_LED              P_GPIO_48
#define PAD_GREEN_LED               PAD_PIN_PGPIO48
...
#define GPIO_WIFI_LED              P_GPIO_36
#define PAD_WIFI_LED               PAD_PIN_PGPIO36

#define GPIO_GPS_DET 	           D_GPIO_6
#define PAD_GPS_DET                 PAD_PIN_DGPIO6

#define GPIO_LDWS_BEEP            P_GPIO_51
//--------------------------------------------------------------------
// Power device
//--------------------------------------------------------------------
//Battery
