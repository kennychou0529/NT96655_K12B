...
SHOW_ITEM_GROUP(CMD_Group,Normal6,47,37,74,64)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Flash,0,47,37,74,64)
...
SHOW_ITEM_GROUP(CMD_Group,Normal74,54,5,81,32)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_Protect,0,54,5,81,32)
...
CREATE_STATE_ITEM_DATA(ICON_OK_PAUSE92,STRID_NULL,ICON_OK_PAUSE,NULL) 
...
STATE_LIST_ITEM(ICON_OK_PAUSE92)
...
SHOW_ITEM_GROUP(CMD_Group,Normal94,73,207,126,234)

CREATE_STATE_ITEM_DATA(ICON_FB_LEFT97,STRID_NULL,ICON_FB_LEFT,NULL) 
CREATE_STATE_ITEM_DATA(ICON_FB_LEFT_BLUE98,STRID_NULL,ICON_FB_LEFT_BLUE,NULL) 
...
STATE_LIST_ITEM(ICON_FB_LEFT97)
STATE_LIST_ITEM(ICON_FB_LEFT_BLUE98)
STATE_LIST_END

CREATE_STATE_DATA(UIFlowWndPlay_StatusICN_MovBwd,0)
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovBwd,0,73,207,126,234)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin100Rect,0,0,81,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin100)
SHOW_MAP_BODY(Skin100Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin100,0,0,81,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text102,1,0,80,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal99)
SHOW_MAP_BODY(Skin100)
SHOW_MAP_BODY(Text102)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal99,227,32,308,59)
...
SHOW_ITEM_GROUP(CMD_Group,Skin105,0,0,53,27)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon106, 0, 0, 53,25, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal104)
SHOW_MAP_BODY(Skin105)
SHOW_MAP_BODY(Icon106)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal104,135,206,188,233)

CREATE_STATE_ITEM_DATA(ICON_FF_RIGHT107,STRID_NULL,ICON_FF_RIGHT,NULL) 
CREATE_STATE_ITEM_DATA(ICON_FF_RIGHT_BLUE108,STRID_NULL,ICON_FF_RIGHT_BLUE,NULL) 
...
STATE_LIST_ITEM(ICON_FF_RIGHT107)
STATE_LIST_ITEM(ICON_FF_RIGHT_BLUE108)
STATE_LIST_END

CREATE_STATE_DATA(UIFlowWndPlay_StatusICN_MovFwd,0)
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovFwd,0,135,206,188,233)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon111, 0, 0, 27,27, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal109)
SHOW_MAP_BODY(Skin110)
SHOW_MAP_BODY(Icon111)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal109,12,109,39,136)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_Print,0,12,109,39,136)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin114Rect,0,0,59,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin114)
SHOW_MAP_BODY(Skin114Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin114,0,0,59,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text116,0,0,59,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal113)
SHOW_MAP_BODY(Skin114)
SHOW_MAP_BODY(Text116)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal113,129,181,188,208)
...
SHOW_ITEM_GROUP(CMD_Group,Skin119,0,0,53,27)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon120, 0, 0, 53,25, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal118)
SHOW_MAP_BODY(Skin119)
SHOW_MAP_BODY(Icon120)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal118,12,207,65,234)

CREATE_STATE_ITEM_DATA(ICON_OK_STOP121,STRID_NULL,ICON_OK_STOP,NULL) 
...
STATE_LIST_ITEM(ICON_OK_STOP121)
STATE_LIST_END

CREATE_STATE_DATA(UIFlowWndPlay_StatusICN_MovStop,0)
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovStop,0,12,207,65,234)
